...
class SigmaSettings:
    ...
    def __init__(self):
        ...
        self.DATABASE_URL: str = os.getenv(
            "SIGMA_DATABASE_URL", "sqlite:///./data/sigma_translator.db"
        )
        ...
        self.LLM_PROVIDER: str = os.getenv(
            "SIGMA_LLM_PROVIDER", "offline"
        )  # offline, openai, azure, groq
        self.LLM_API_KEY: Optional[str] = (
            os.getenv("SIGMA_LLM_API_KEY")
